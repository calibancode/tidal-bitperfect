...
def main() -> int:
    checks = [
        ...
        ("qt6/tidal_sidecar.cpp", r"cmdPrefetch.*fetchStreamCandidates.*storeAudio", "queued stream prefetch into audio cache"),
        ("qt6/tidal_sidecar.cpp", r"cmdDetails.*loadTrack", "track detail hydration endpoint"),
        ("qt6/tidal_sidecar_endpoints.cpp", r"audioDir.*audioPath.*storeAudio.*QStringLiteral\(\"audio\"\)", "audio cache write path"),
        ...
        ("qt6/tidal_sidecar.cpp", r"target_bit_depth.*target_sample_rate.*cache_reason.*cache_priority.*targetSampleFormat", "prefetch preserves native PCM format compatibility and cache intent"),
