...
def main() -> int:
    checks = [
        ...
        ("qt6/main_window.cpp", r"shouldRememberTrackObject.*rememberTracks", "track cache avoids container pollution"),
        ("qt6/main_window.cpp", r"qualityLabelText.*formatReady", "local playback quality reconstruction"),
